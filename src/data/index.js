...
export const INITIAL_PROJECTS = [
  { id:1, title:"Vital Sync", description:"A responsive health & productivity app syncing user data in real time using TanStack Query for efficient state and API management.", tech:["React","Tailwind CSS","TanStack Query","JavaScript"], emoji:"🫀", color:"rose", liveLink:"https://digital-clock-ten-psi-89.vercel.app/", githubLink:"https://github.com/Mahikhalid123/Digital-Clock/tree/main/src" },
  { id:2, title:"PopCorn", description:"Dynamic movie search & rating app with watchlists, filtering, and smooth routing powered by React Router DOM.", tech:["React","Tailwind CSS","TanStack Query","React Router DOM"], emoji:"🍿", color:"amber", liveLink:"https://the-wild-oasis-mjkp.vercel.app/", githubLink:"https://github.com/Mahikhalid123/The-Wild-Oasis" },
  { id:3, title:"E-Commerce", description:"Elegant e-commerce brand website with products, categories, and Redux state management with Tailwind CSS styling.", tech:["React","Redux","Tailwind CSS","JavaScript"], emoji:"🛍️", color:"violet", liveLink:"https://ecommerce-sigma-nine-87.vercel.app/", githubLink:"https://github.com/khalidmehmooddadla123-hub/Ecommerce" },
  { id:4, title:"ProductivityHub", description:"A responsive Product Dashboard that allows users to manage, track, and analyze product data in real time. Built with React and modern UI components for a smooth and intuitive user experience.", tech:["React","Tailwind CSS","React Router DOM","JavaScript"], emoji:"📊", color:"red", liveLink:"https://task-dashboard-rouge.vercel.app/", githubLink:"https://github.com/khalidmehmooddadla123-hub/TaskDashboard" },
  { id:5, title:"Currency Converter", description:"Modern currency converter fetching live exchange rates via APIs, updating instantly with TanStack Query.", tech:["React","Tailwind CSS","TanStack Query","JavaScript"], emoji:"💱", color:"emerald", liveLink:"https://converter-nine-nu.vercel.app/", githubLink:"https://github.com/Mahikhalid123/Converter" },
  { id:6, title:"Quiz Application", description:"A responsive Quiz Application built to deliver an engaging learning experience with real-time scoring, instant results, and a clean user interface.", tech:["React","Leaflet","JavaScript","REST APIs"], emoji:"🧠", color:"cyan", liveLink:"https://js-basics-m5iz.vercel.app/", githubLink:"https://github.com/khalidmehmooddadla123-hub/QuizApplication" },
];
